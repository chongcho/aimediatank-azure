...
- [ ] **App name** — Max 50 characters (e.g. “AI Media Tank (AiM)”).
...
- [ ] **App bundle** — You need at least one **Android App Bundle** (.aab) or APK. If AI Media Tank (AiM) is distributed as a web app, this comes from a wrapper (e.g. TWA, Capacitor, PWA Builder).
...
## Quick reference — AI Media Tank (AiM) URLs
