# Google Play — Publish AI Media Tank (AMT) Checklist

Your app **AI Media Tank (AMT)** (`com.aimediatank.app`; legal entity **AI Media Tank, LLC (AMT)**) is in **Draft** with **Internal testing**. Use this checklist to get it listed on Google Play.
...
- [ ] **App name** — Max 50 characters (e.g. “AI Media Tank (AMT)”).
...
- [ ] **App bundle** — You need at least one **Android App Bundle** (.aab) or APK. If AI Media Tank (AMT) is distributed as a web app, this comes from a wrapper (e.g. TWA, Capacitor, PWA Builder).
...
## Quick reference — AI Media Tank (AMT) URLs
