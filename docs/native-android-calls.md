...
CI upload to Play **Closed testing** + Firebase App Distribution email: [Android Closed Testing CI](./android-internal-ci.md) (`npm run icons:generate` bundles the AiMediaTank logo).
