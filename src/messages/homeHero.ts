...
const TR: Pack = {
  ...EN,
  slogan: "YZ ve gerçek içerik üreticileri ile dijital meraklılar için topluluk",
  searchPlaceholder: "Medya veya @kullanıcıadı ara...",
  search: "Ara",
  searching: "Aranıyor...",
  users: "Kullanıcılar",
  ...
  sortBy: "Sırala:",
  sortAria: "Medyayı sırala",
  mostPopular: "En Popüler",
  mostRecent: "En Yeni",
  random: "Rastgele",
  showingFrom: "İçerik kaynağı:",
  showingResults: "Sonuçlar:",
  clearSearch: "Aramayı temizle",
}

const FIL: Pack = {
  ...EN,
  slogan: "Community para sa AI at Real Content Creators at Digital Enthusiasts",
  searchPlaceholder: "Maghanap ng media o @username...",
  search: "Search",
  ...
  sortAria: "I-sort ang media",
  mostPopular: "Pinakasikat",
  mostRecent: "Pinakabago",
  random: "Random",
  showingFrom: "Ipinapakita ang content mula kay:",
  showingResults: "Mga resulta para sa:",
  clearSearch: "I-clear ang search",
}

const VI: Pack = {
  ...EN,
  slogan: "Cộng đồng dành cho nhà sáng tạo nội dung AI & thực tế và những người đam mê số",
  searchPlaceholder: "Tìm media hoặc @tênngười dùng...",
  search: "Tìm kiếm",
  searching: "Đang tìm...",
  users: "Người dùng",
  ...
  sortBy: "Sắp xếp:",
  sortAria: "Sắp xếp media",
  mostPopular: "Phổ biến nhất",
  mostRecent: "Mới nhất",
  random: "Ngẫu nhiên",
  showingFrom: "Nội dung từ:",
  showingResults: "Kết quả cho:",
  clearSearch: "Xóa tìm kiếm",
}

const ID: Pack = {
  ...EN,
  slogan: "Komunitas untuk kreator konten AI & nyata serta penggemar digital",
  searchPlaceholder: "Cari media atau @namapengguna...",
  search: "Cari",
  searching: "Mencari...",
  users: "Pengguna",
  ...
  sortBy: "Urutkan:",
  sortAria: "Urutkan media",
  mostPopular: "Paling Populer",
  mostRecent: "Terbaru",
  random: "Acak",
  showingFrom: "Konten dari:",
  showingResults: "Hasil untuk:",
  clearSearch: "Hapus pencarian",
}

const TH: Pack = {
  ...EN,
  slogan: "ชุมชนสำหรับครีเอเตอร์เนื้อหา AI และจริง รวมถึงผู้หลงใหลดิจิทัล",
  searchPlaceholder: "ค้นหาสื่อหรือ @ชื่อผู้ใช้...",
  search: "ค้นหา",
  ...
  mostRecent: "ล่าสุด",
  random: "สุ่ม",
  showingFrom: "แสดงเนื้อหาจาก:",
  showingResults: "ผลลัพธ์สำหรับ:",
  clearSearch: "ล้างการค้นหา",
}

const MS: Pack = {
  ...EN,
  slogan: "Komuniti untuk pencipta kandungan AI & nyata serta peminat digital",
  searchPlaceholder: "Cari media atau @namapengguna...",
  search: "Cari",
  searching: "Mencari...",
  users: "Pengguna",
  ...
  mostRecent: "Paling Baharu",
  random: "Rawak",
  showingFrom: "Kandungan daripada:",
  showingResults: "Hasil untuk:",
