...
const EN: Pack = {
  ...
  aiBadge: 'AI',
  realBadge: 'Real',
  signInToPostComment: 'Sign in to post a comment.',
  ...
  save: 'Save',
  post: 'Post',
  signInBlurb: 'Sign in to add a comment on this media.',
...
const JA: Pack = {
  ...
  aiBadge: 'AI',
  realBadge: '実写',
  signInToPostComment: 'コメントするにはサインインしてください。',
  ...
  save: '保存',
  post: '投稿',
  signInBlurb: 'このメディアにコメントするにはサインインしてください。',
