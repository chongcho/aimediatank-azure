/**
 * Pause all video and audio on the page without clearing sources.
 * Use when overlays (e.g. share dialog) should stop playback while keeping the player state intact.
 */
