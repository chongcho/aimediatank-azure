    ...
    try {
      switch (source) {
        case 'stripe_fee': {
          ...
          mail = {
            subject: `🎉 Upload Complete: "${media.title}" | AI Media Tank (AMT)`,
        ...
        case 'credit': {
          ...
          mail = {
            subject: '✅ Upload Complete (Credit Used) | AI Media Tank (AMT)',
        ...
        case 'premium': {
          ...
          mail = {
            subject: '🎬 Upload Successful! | AI Media Tank (AMT)',
            html: generateUploadConfirmationEmail(
              userName,
              media.title,
              totalUploads,
        ...
        default: {
          ...
          mail = {
            subject: `🎬 Your video is ready: "${media.title}" | AI Media Tank (AMT)`,
