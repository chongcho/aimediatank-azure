...
const DEFAULT_SENDER_NAME = process.env.AZURE_EMAIL_SENDER_NAME || 'AI Media Tank (AMT)'
  ...
  try {
    ...
    const poller = await client.beginSend({
      ...
      ...(options.replyTo
        ...
        : { replyTo: [{ address: 'support@aimediatank.com', displayName: 'AI Media Tank (AMT) Support' }] }
      ),
    })
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p style="font-size: 12px; color: #999; margin-top: 30px;">
    This email was sent because you made a purchase on AI Media Tank (AMT). If you have any questions, please contact our support team.
  </p>
</body>
</html>
`
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p style="font-size: 16px;">Thank you for registering with AI Media Tank (AMT)! Please verify your email address by clicking the button below:</p>
  ...
  <p style="font-size: 14px; color: #666;">If you didn't create an account with AI Media Tank (AMT), you can safely ignore this email.</p>
  ...
  <p style="font-size: 12px; color: #999; margin-top: 30px;">
    This email was sent because someone registered with this email address on AI Media Tank (AMT).
  </p>
</body>
</html>
`
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p style="font-size: 16px;">Thank you for subscribing to AI Media Tank (AMT)! Your membership is now active.</p>
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p style="font-size: 16px;">Your account has received a warning from the AI Media Tank (AMT) moderation team.</p>
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p style="font-size: 16px;">Your AI Media Tank (AMT) account has been suspended ${duration}.</p>
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p style="font-size: 16px;">Good news! Your AI Media Tank (AMT) account has been reinstated and is now fully active.</p>
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p style="font-size: 16px;">Great news! You've received bonus upload credits from AI Media Tank (AMT).</p>
  ...
  <p style="font-size: 12px; color: #999; margin-top: 30px;">
    This email was sent because you received bonus credits on AI Media Tank (AMT). If you have any questions, please contact our support team.
  </p>
</body>
</html>
`
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p style="font-size: 16px;">Your AI Media Tank (AMT) account has been permanently deleted.</p>
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p style="font-size: 16px;">You have received a warning for your chat message on AI Media Tank (AMT).</p>
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p style="font-size: 16px;">Your chat message on AI Media Tank (AMT) has been deleted by a moderator.</p>
