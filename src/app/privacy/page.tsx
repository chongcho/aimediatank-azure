    ...
    <div className="max-w-4xl mx-auto p-0 m-0 pb-[500px]">
      ...
      <div className="card prose prose-invert max-w-none">
        ...
        <p className="text-gray-300 mb-6">
          AI Media Tank (AiM), LLC (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) operates the website and platform available at <strong>https://www.aimediatank.com</strong> (the &quot;Platform&quot;). This Privacy Policy explains how we collect, use, disclose, and safeguard information when you access or use the Platform and related services.
        </p>
        ...
        <p className="text-gray-300 mb-4">Payment card or financial details are processed by third-party payment processors and are generally not stored directly by AI Media Tank (AiM), LLC.</p>
        ...
        <p className="text-gray-300 mb-2">AI Media Tank (AiM), LLC may use automated systems and algorithms to process platform data and uploaded content for purposes such as:</p>
        <ul className="list-disc list-inside text-gray-300 space-y-1 mb-4">
        ...
        <p className="text-gray-300 mb-4">AI Media Tank (AiM), LLC does not use user-uploaded content to train artificial intelligence models without explicit permission from the content owner.</p>
        ...
        <ul className="list-disc list-inside text-gray-300 space-y-1 mb-4">
          ...
          <li>protect the rights, property, or safety of AI Media Tank (AiM), LLC, our users, or the public</li>
        </ul>

        <h3 className="text-lg font-semibold mt-6 mb-3">4.3 Business Transfers</h3>
        <p className="text-gray-300 mb-4">If AI Media Tank (AiM), LLC undergoes a merger, acquisition, financing, reorganization, or sale of assets, user information may be transferred as part of that transaction.</p>
        ...
        <p className="text-gray-300 mb-2">AI Media Tank (AiM), LLC implements reasonable administrative, technical, and organizational safeguards designed to protect user information, including:</p>
        <ul className="list-disc list-inside text-gray-300 space-y-1 mb-4">
        ...
        <p className="text-gray-300 mb-4">AI Media Tank (AiM), LLC does not sell personal information.</p>
        ...
        <p className="text-gray-300 mb-4">AI Media Tank (AiM), LLC operates from the United States.</p>
        ...
        <p className="text-gray-300 mb-4">Some browsers include a &quot;Do Not Track&quot; feature. Because there is not yet a universally accepted standard for responding to such signals, AI Media Tank (AiM), LLC currently does not respond to Do Not Track requests.</p>
        ...
        <div className="bg-tank-dark rounded-xl p-4 space-y-2 mb-4">
          <p className="text-gray-300"><strong>AI Media Tank (AiM), LLC</strong></p>
