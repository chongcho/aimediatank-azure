                    ...
                    <div>
                      ...
                      {mediaType === 'video' && (
                        <p className="text-xs text-gray-500 mb-3 leading-relaxed">
                          ...
                          use 30 fps for App Store previews. Odd sizes (e.g. 886×1920) use software H.264 with quality
                          (QP) control so bitrate can reach the target; MediaRecorder is only used when WebCodecs is
                          unavailable.
                        </p>
                      )}
