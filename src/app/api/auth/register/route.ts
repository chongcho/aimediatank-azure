...
export async function POST(request: Request) {
  try {
    ...
    console.log(`Subject: Welcome to AI Media Tank (AiM) - Verify your email`)
    console.log(``)
    console.log(`Hello ${user.name || user.username},`)
    console.log(``)
    console.log(`Welcome to AI Media Tank (AiM)! Please click the link below to verify your email:`)
