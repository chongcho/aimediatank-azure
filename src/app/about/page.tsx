...
const features = [
  ...
  { icon: '📱', title: 'Progressive Web App', desc: 'Install AiMediaTank on any device. Offline-capable, home screen icon, push notifications — native app experience.' },
    ...
    <div className="min-h-screen bg-tank-dark text-white pb-[500px]">
      ...
      <section className="py-20 px-4 bg-tank-gray/30">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mt-2 mb-8">Why We Built AiMediaTank</h2>
          ...
          <div className="space-y-6 text-gray-300 leading-relaxed text-base md:text-lg">
            ...
            <p>
              <span className="text-white font-semibold">AiMediaTank was founded to change that.</span> We set out 
            ...
            <p>
              ...
              evolution of creative technology — AiMediaTank is the professional space where your work belongs.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mt-2">Who Thrives on AiMediaTank</h2>
          ...
          <div className="mt-10 bg-gradient-to-r from-tank-accent/5 to-purple-500/5 border border-tank-light rounded-2xl p-6 md:p-8">
            ...
            <p className="text-gray-400 leading-relaxed">
              You do not need to be a professional to enjoy AiMediaTank. Enthusiasts, collectors, and curious 
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mt-2">How AiMediaTank Works</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                AiMediaTank is not just a gallery — it is a fully integrated marketplace. Every creator can set 
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-400 mt-3 max-w-3xl mx-auto">
              AiMediaTank is built on a modern, scalable architecture designed for production reliability. 
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div>
                ...
                <p className="text-gray-300 leading-relaxed mb-4">
                  AiMediaTank is proudly built using <span className="text-white font-semibold">Cursor</span>, 
      ...
      <section className="py-20 px-4 bg-tank-gray/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-400 mt-3 max-w-3xl mx-auto">
              Every aspect of AiMediaTank runs on Azure cloud infrastructure — from web hosting and database management 
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                AiMediaTank follows modern DevOps practices with GitHub at the center of the development workflow. 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                ...
                a dedicated platform to share and monetize their work. AiMediaTank is positioned at the 
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-tank-accent/15 via-tank-dark to-purple-600/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            ...
            boundaries, or a technologist building the future — AiMediaTank is the professional platform 
