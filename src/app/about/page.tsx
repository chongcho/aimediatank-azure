...
const features = [
  ...
  { icon: '🎮', title: 'Interactive Games', desc: 'Built-in retro games — Pac-Man, Tetris, Racquetball, Breakout, Donkey Kong, and Minesweeper — for a fun break between creating.' },
