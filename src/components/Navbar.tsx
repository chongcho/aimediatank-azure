        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            {isNavbarItemEnabled('mediaMessage') && (
              <Link
                href="/ecard"
                className="inline-flex h-9 w-12 shrink-0 items-center justify-center rounded-lg bg-pink-500 px-px text-center hover:bg-pink-600 transition-colors"
                aria-label="Card"
                title="Card"
              >
            ...
            {isNavbarItemEnabled('chat') && (
              <div className="relative">
                <button
                  ...
                  className="inline-flex h-9 w-12 shrink-0 items-center justify-center rounded-lg bg-yellow-300 px-px text-center hover:bg-yellow-400 transition-colors"
              ...
              <>
                ...
                {isNavbarItemEnabled('upload') && (
                  <Link
                    ...
                    className="inline-flex h-9 w-12 shrink-0 items-center justify-center rounded-lg bg-blue-600 px-px text-center hover:bg-blue-700 transition-colors"
                  >
