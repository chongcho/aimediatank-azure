...
export function VoiceCallOverlayPanel({
  ...
  // the web overlay when nativeOwnsVideo is actually set (audio-native or lock-screen).
    ...
    <VoiceCallOverlay
      ...
      onAccept={() => {
        void (async () => {
          ...
          // Android: answerCall owns Telecom answer (voice + WebView video with skipNativeWebRtc).
